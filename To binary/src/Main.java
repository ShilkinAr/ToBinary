...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("Хотите перевести ещё одно число? 0 - да, Остальное - нет.");
	...
	public static void watsTheTypeFractional() {
		...
		System.out.println("В какой тип необходимо перевести? FLOAT(4), DOUBLE(5)");
	...
	public static void watsTheTypeIntegral(long numberIn) {
		...
		switch (type) {
		case 0:
			System.out.println("В какой тип необходимо перевести? BYTE(0), SHORT(1), INT(2), LONG(3)");
			System.out.println("Введите число от 0 до 3");
			preferredType = type1.nextByte();
			break;
		case 1:
			System.out.println("В какой тип необходимо перевести? SHORT(1), INT(2), LONG(3)");
			System.out.println("Введите число от 1 до 3");
			preferredType = type1.nextByte();
			break;
		case 2:
			System.out.println("В какой тип необходимо перевести? INT(2), LONG(3)");
